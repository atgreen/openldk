...
openldk: src/*.lisp src/native/*.lisp *.asd Makefile | check-jdk
...
javacl: src/*.lisp src/native/*.lisp *.asd Makefile | check-jdk
...
kawa: src/*.lisp src/native/*.lisp *.asd Makefile $(KAWA_JAR)
