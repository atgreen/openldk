...
(defparameter +bytecode-1-byte+
  '(:AALOAD :AASTORE
    ...
    :CALOAD :CASTORE
    :D2L
    :DADD :DCONST_0 :DCONST_1 :DDIV :DLOAD_2 :DMUL :DSTORE :DSTORE_2 :DSUB
    :DRETURN
    :DUP :DUP_X1 :DUP2
    :F2I :F2D
    :FCMPG :FCMPL
    ...
    :FRETURN
		:I2C :I2F :I2L
    :IADD :IAND :IALOAD :INEG :IASTORE :IOR :IXOR
...
(defparameter +bytecode-2-byte+
  '(:ALOAD :ASTORE :BIPUSH :DLOAD :FLOAD :DSTORE :FSTORE :ILOAD :LLOAD :LSTORE :ISTORE :LDC :NEWARRAY))

(defparameter +bytecode-3-byte+
  '(:CHECKCAST
    :GETFIELD :GETSTATIC :GOTO :IINC
    :IF_ACMPEQ :IF_ACMPNE :IF_ICMPEQ :IF_ICMPGE :IF_ICMPLE :IF_ICMPLT :IF_ICMPGT :IF_ICMPNE :IFEQ :IFGE :IFLE
...
(defparameter +bytecode-short-branch-table+
  (let ((sbtable (make-hash-table)))
    (dolist (o '(:GOTO :IF_ACMPEQ :IF_ACMPNE :IF_ICMPLE :IF_ICMPLT :IF_ICMPGT :IF_ICMPEQ :IF_ICMPGE :IF_ICMPNE :IFEQ :IFGE :IFLE :IFLT :IFGT :IFNE :IFNONNULL :IFNULL))
