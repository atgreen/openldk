...
public class StackTrace2
{
                	...
                	String expected_method, int expected_line)
  {
    if (frame.getClassName().equals(expected_cl))
      System.out.println(expected_cl);
    else
      System.out.println("FAIL - expected " + expected_cl + ", got: " +
		       frame.getClassName());

    System.out.print(".");

    if (frame.getMethodName().equals(expected_method))
      System.out.println(expected_method);
    else
      System.out.println("FAIL - expected " + expected_method + ", got: " +
		       frame.getMethodName());
